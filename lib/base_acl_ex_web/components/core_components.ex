defmodule BaseAclExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BaseAclExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BaseAclExWeb.Gettext, "errors", msg, opts)
    end
  end
