defmodule BaseAclEx.Accounts.Core.Entities.User do
  ...
  @optional_fields [:username, :first_name, :last_name, :phone, :avatar_url,
                    :is_active, :metadata, :preferences, :two_factor_enabled]
  @update_fields [:first_name, :last_name, :phone, :avatar_url, :username,
  ...
  """
  def display_name(%__MODULE__{username: username}) when is_binary(username) and username != "", do: username
